...
const data = {
  ...
  "3danimation": {
    ...
    heading:
      "The Creative Animation Studio That Brings Your Vision To Life.",
    description:
  ...
  return (
    <>
      ...
      <section className={styles.detailHead}>
        <div className="container">
          <TitleDescription
            title={serviceData.DescTitle}
            description={
              <span className={styles.paraColor}>
                {serviceData.Descpara}
              </span>
            }
            ...
            subhead4={serviceData.subhead4}
            subdes4={serviceData.subdes4}
          />
        </div>
      </section>
